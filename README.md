# EasyStyle - Fashion Discovery Platform

## Live Demo
🚀 https://easystyle.streamlit.app/

## Overview

EasyStyle is a full-stack fashion discovery platform that aggregates and organizes fashion catalog data from e-commerce sources into a centralized browsing experience.
...
- Automated product data extraction using Playwright
- Expansion of catalog coverage
- Application architecture improvements
- Preparation for future AI-powered recommendation features
